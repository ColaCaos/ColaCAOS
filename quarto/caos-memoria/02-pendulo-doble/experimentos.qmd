...
Aquí se ve el péndulo doble en movimiento con las diferentes partes representadas con un punto de un color, que es lo que le sirve al programa para determinar las trayectorias.
...
Se puede apreciar como al principio su trayectoria diverge muy rápidamente, pero al final, cuando ya han perdido mucha velocidad, hacen todos un recorrido muy similar hasta detenerse.
