...
Como dijimos en la sección anterior, a partir de $r_\infty \approx 3.56995$, el mapa logístico entra en un **régimen caótico**. Para $r < r_\infty$, aparecían sucesivas bifurcaciones de periodo $1 \to 2 \to 4 \to 8 \to \cdots$.
...
## División en bandas
Justo tras $r_\infty$, la zona caótica se **parte en dos bandas** distintas: en el diagrama de bifurcación aparecen dos hileras de puntos con un hueco entre ellas.
