...
Intuitivamente, si comenzamos en $x^*$ y aplicamos la función, nos quedamos en el mismo punto. En la sección anterior vimos que en el diagrama interactivo graficábamos también la función $y=x$. Si nuestra función $f(x)=x" cruza en algún momento la función $y=x$, entonces tenemos un punto fijo en nuestra función. 
