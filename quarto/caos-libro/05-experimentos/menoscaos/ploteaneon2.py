...
if os.path.exists(smoothed):
    ...
    p_y = "NuevaRuedaCaoticaSimetricaAnilloConSinCanicasAceroFuenteMejoradaMasAgua_Transfer_plot_00010.csv"
...
if len(df) > MAX_POINTS:
    ...
    dfp = df
# Filtro de tiempo: solo de 10 a 1000 segundos
if "Time" in dfp.columns:
    dfp = dfp[(dfp["Time"] >= 100) & (dfp["Time"] <= 1000)]
