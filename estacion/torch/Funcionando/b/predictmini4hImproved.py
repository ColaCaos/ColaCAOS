...
# Definición del modelo (mismo que en entrenamiento, con dropout aplicado si se entrenó con él)
...
def main():
    ...
    # Ajuste de la forma del DataFrame si es necesario
    ...
    while current_time <= end_pred:
        ...
        with torch.no_grad():
            pred = model(x_input)  # [1, 72, num_features]
    ...
    # Extraer predicciones realizadas 4h, 8h y 12h antes (índices 3, 7 y 11 respectivamente)
    ...
    # Graficar y guardar CSV para cada variable
