...
class ForecastNet(nn.Module):
    ...
    def forward(self, src, target_seq=None, teacher_forcing_ratio=0.0):
        ...
        # Inicialización del decoder: se toman las variables objetivo de Galapagar.
        # En el DataFrame, para Galapagar, las features no tienen prefijo y están en BASE_FEATURES,
...
def main():
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        for batch_idx, (batch_x, batch_y) in enumerate(train_loader):
            ...
            # Imprimir cada 10 batches o en el último batch
